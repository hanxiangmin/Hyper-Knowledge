...
This module exports the fundamental "AutoType" primitives of the Hyper-Knowledge framework.
...
## 3. Graph Types (图谱型)
*   **`AutoGraph`**: Standard undirected pairwise knowledge graph.
    *   *Scope*: Modeling a symmetric relationship between two entities.
