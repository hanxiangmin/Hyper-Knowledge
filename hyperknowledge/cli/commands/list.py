"""List command for Hyper-Knowledge CLI."""
...
from hyperknowledge.utils.template_engine import Gallery

logger = get_logger("hk.list")
console = Console()
...
def template(
    ...
    if include_methods and target_lang != "zh":
        from hyperknowledge.methods import list_method_cfgs
    ...
    console.print()
    console.print(
        "[dim]Tip: Use [bold]hk parse <input> -t <template_id> -l <lang>[/bold] to extract with a template[/dim]"
    )
...
def method(
    ...
    from hyperknowledge.methods import list_methods
    ...
    console.print()
    console.print(
        "[dim]Tip: Use [bold]hk parse <input> -m <method_name>[/bold] to extract with a method[/dim]"
    )
