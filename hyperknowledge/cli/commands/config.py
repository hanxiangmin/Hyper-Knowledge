"""Config command for Hyper-Knowledge CLI."""
...
def config_callback(
    ...
    """Show configuration help when running 'hk config' without subcommand."""
    ...
    commands_info = [
        ...
        ("hk config show", "Display current configuration"),
        ("hk config llm", "Configure LLM settings"),
        ("hk config embedder", "Configure Embedder settings"),
    ]
    ...
    console.print()
    console.print(
        "  [yellow]1.[/yellow] Run [green]hk config init[/green] for interactive setup"
    )
    console.print("  [yellow]2.[/yellow] Or configure individually:")
    console.print("     [green]hk config llm --api-key YOUR_KEY[/green]")
    console.print("     [green]hk config embedder --api-key YOUR_KEY[/green]")
    console.print()
    ...
    hint_text.append("hk config <command> --help", style="bold cyan")
...
def _show_config():
    ...
    table = Table(title="Hyper-Knowledge Configuration")
...
def init(
    ...
    if provider and api_key:
        from hyperknowledge.utils.client import PROVIDER_PRESETS
    ...
    # Single-key quick mode: only api_key provided (OpenAI defaults)
    ...
    # Interactive mode
    console.print("[bold blue]Hyper-Knowledge Configuration Setup[/bold blue]")
    console.print()
