...
class TestCLINoVerboseFlag:
    ...
    def test_version_works_without_verbose(self):
        ...
        assert result.exit_code == 0
        assert "Hyper-Knowledge CLI" in result.output
